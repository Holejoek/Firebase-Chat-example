...
class RegisterViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let gesture = UITapGestureRecognizer(target: self,
                                             action: #selector(didTapChaneProfilePicture))
    ...
    func alertUserLoginError(message: String = "Please enter full imformation to create a new account") {
